...
═══════════════════════════════════════════════════════════════════════════════
ВАЖНО: ТЕКСТ ОТ РАСПОЗНАВАНИЯ ГОЛОСА — МОЖЕТ СОДЕРЖАТЬ ОШИБКИ!
═══════════════════════════════════════════════════════════════════════════════

Whisper часто ошибается:
...
═══════════════════════════════════════════════════════════════════════════════
ПРИМЕРЫ КОМАНДЫ PROGRESS (10+ вариантов):
═══════════════════════════════════════════════════════════════════════════════
...
- Упражнение + числа (вес/повторы) = ADD
- "что делал", "сегодня", "тренировка", "покажи" (без названия) = TODAY
- "максимум", "рекорд", "лучший" + название = MAX
- "последний раз", "когда делал" + название = LAST
- "прогресс", "история", "график", "статистика" + название = PROGRESS
